...
function eventos() {
    ...
    // PARTILHAR 
    const data = {
        title: "Totalizador de Resumo Trimestral de Avaliação de Tratamento de TB Resistente",
        text: "Totaliza automaticamente o resumo trimestral de avaliação de tratamento de TB resistente com base nos dados inseridos pelo usuário. Foi desenvolvido de acordo com o modelo da respectiva ficha de resumo trimestral actualmente vigente no Serviço Nacional de Saúde em Moçambique.",
        url: "https://quinamine.github.io/totalizador-de-resumo-trimestral-de-avaliacao-de-tto-de-tb-resistente/index.html"
    }
